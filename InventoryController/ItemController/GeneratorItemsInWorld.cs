...
public class GeneratorItemsInWorld : MonoBehaviour
{
    ...
    private static SortingLayerController sortLayer = new SortingLayerController();
    private void Start()
    {
    ...
    public static void GenerateItem(Item_Object item, Transform positionSpawn)
    {
        ...
        tempItem.GetComponent<SpriteRenderer>().sortingOrder = sortLayer.LayerOrderController(tempItem) -1 ;
    }
    public static void GenerateItem(Weapon weaponItem,Transform positionSpawn)
    {
        ...
        itemWeapon.GetComponent<SpriteRenderer>().sortingOrder = sortLayer.LayerOrderController(itemWeapon) -1;
    }
    public static void GenerateItem(Distant distantItem, Transform positionSpawn)
    {
        ...
        itemDistant.GetComponent<SpriteRenderer>().sortingOrder = sortLayer.LayerOrderController(itemDistant) - 1;
    }
}
